...
def get_config():
    ...
    parser.add_argument('-sw', '--save_window', dest='save_window', help='Saving the trained information every save_window epoch', type=int, required=False, default=40)
    ...
    parser.add_argument('-ne', '--num_epochs', dest='num_epochs', help='Number of epochs for training the embedding model', type=int, required=False, default=80)
